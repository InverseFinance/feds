...
forge create --rpc-url $1 \
    --constructor-args $dola $aura $vault $booster $chair $guardian $gov $maxLossExpansion $maxLossWithdraw $maxLossTakeProfit $poolId\
    --private-key $3 src/aura-fed/AuraStablepoolFed.sol:AuraStablepoolFed \
    --etherscan-api-key $2 \
    --verify
